...
type BoxProps = SS.LayoutProps & SS.SpaceProps & SS.PositionProps & SS.ColorProps & SS.BorderProps;

const Box = styled.div<BoxProps>(compose(layout, space, position, color, border));
