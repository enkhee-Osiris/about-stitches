...
const Text = styled.div<CommonTypographyProps>(compose(color, typography, space));
Text.defaultProps = {
  color: "primary",
  fontFamily: "text",
  fontSize: "text",
...
const CodeSpan = styled.code<CommonTypographyProps>(compose(color, typography, space));
...
const Quote = styled(Text as FC<CommonTypographyProps & Pick<BorderProps, "borderColor">>)`
  border-left: 1px solid ${({ theme, borderColor }) => borderColor || theme.colors.secondary};
...
const ListItem = styled.li<CommonTypographyProps>(compose(color, typography, space));
