...
export function overviewWrapperStyle({ overviewScale }: { overviewScale: number }): CSSProperties {
  return {
...
export function printWrapperStyle({ printScale }: { printScale: number }): CSSProperties {
  return {
