...
import defaultTheme, { SpectacleThemeOverrides } from "../../theme/default-theme";
...
const Portal = styled.div<PortalProps>(({ fitAspectRatioStyle, overviewMode, printMode }) => [
...
export const DeckInternal = forwardRef<DeckRef, DeckInternalProps>(
  (
    ...
    //       </Deck>
    //     );
    const [slidePortalNode, setSlidePortalNode] = React.useState<HTMLDivElement | null>();
...
export const Deck = DeckInternal as React.FC<DeckProps & React.RefAttributes<DeckRef>>;
