...
/* eslint-disable @typescript-eslint/no-unused-expressions, no-nested-ternary, react/jsx-no-constructed-context-values */
...
export default function Slide({
  ...
  React.useEffect(() => {
    ...
    if (pendingView.stepIndex < 0) {
      ...
      const isSingleForwardStep = activeView.stepIndex === pendingView.stepIndex - 1;
  ...
  useEffect(() => {
    ...
    if (pendingView.slideId === undefined) {
      ...
      const isTransitionToNextSlide = activeView.slideIndex === pendingView.slideIndex - 1;
  ...
  useEffect(() => {
    ...
    if (pendingView.stepIndex < 0) {
      ...
      const isTransitionFromPreviousSlide = activeView.slideIndex === pendingView.slideIndex - 1;
          ...
          ReactDOM.createPortal(
            ...
            >
              <SlideContainer
                ...
                {...swipeHandler}
              >
                <TemplateWrapper style={wrapperOverrideStyle}>{templateElement}</TemplateWrapper>
                <SlideWrapper style={scaledWrapperOverrideStyle} padding={padding}>
                  {children}
                </SlideWrapper>
              </SlideContainer>
            </AnimatedDiv>,
